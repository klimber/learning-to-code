...
def main():
    ...
    if myfile is not None:
        ...
        number = st.slider(
            "Escolha o numero de colunas que deseja ver", min_value=1, max_value=20
        )
        ...
        if select_method == "Média":
            ...
            st.table(
                exploracao_inputado[exploracao_inputado["tipos"] != "object"]["NA %"]
            )
